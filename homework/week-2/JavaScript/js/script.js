...
var p = document.getElementById('creator');
ApplePie.creator = p.textContent;
var li = ul[0].getElementsByTagName('li');
var ingredients = new Array();
for (var i = 0; i < li.length; i++) {
    ApplePie.ingredients.push(li[i].innerText)
}
...
for (var i = 0; i < ApplePie.ingredients.length ; i++) {
	 console.log(i + " = " + ApplePie.ingredients[i]);	
};
...
var img = image[0].addEventListener("click",function(){
    alert("This is an ApplePie!");
    console.log("You clicked on the ApplePie!");
})
...
// ------------------- function returns  -----------------
// When cre
// Your goal in ating a visualisation, for instance about a 400m tall mountain, you
...
// this exercise is to complete the calculations
